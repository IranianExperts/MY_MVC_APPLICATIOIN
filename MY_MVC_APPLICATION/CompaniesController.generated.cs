...
namespace MY_MVC_APPLICATION.Controllers
{
    public partial class CompaniesController
    {
        ...
        [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
        public CompaniesController Actions { get { return MVC.Companies; } }
        ...
        public class ViewsClass
        {
            ...
            public readonly string Create = "~/Views/Companies/Create.cshtml";
            public readonly string Delete = "~/Views/Companies/Delete.cshtml";
            public readonly string Details = "~/Views/Companies/Details.cshtml";
            public readonly string Edit = "~/Views/Companies/Edit.cshtml";
            public readonly string Index = "~/Views/Companies/Index.cshtml";
        }
    }

    [GeneratedCode("T4MVC", "2.0"), DebuggerNonUserCode]
    public partial class T4MVC_CompaniesController : MY_MVC_APPLICATION.Controllers.CompaniesController
    {
        ...
        [NonAction]
        partial void CreateOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.Company country);

        [NonAction]
        public override System.Web.Mvc.ActionResult Create(Models.Company country)
        {
        ...
        [NonAction]
        partial void EditOverride(T4MVC_System_Web_Mvc_ActionResult callInfo, Models.Company country);

        [NonAction]
        public override System.Web.Mvc.ActionResult Edit(Models.Company country)
        {
            var callInfo = new T4MVC_System_Web_Mvc_ActionResult(Area, Name, ActionNames.Edit);
            ModelUnbinderHelpers.AddRouteValues(callInfo.RouteValueDictionary, "country", country);
